...
const T = {
  pt: {
    ...
    'faq.a2':'Sim. Nossa estrutura logística permite atender clientes em todas as regiões do país, com prazos e condições alinhados a cada operação.',
    'faq.q3':'Quais linhas de produtos vocês oferecem?',
    'faq.a3':'Trabalhamos com linha hospitalar, monitorização, suporte à vida, acessórios e descartáveis. O portfólio completo pode ser consultado com a equipe comercial.',
    'faq.q4':'Como solicito um orçamento?',
    'faq.a4':'Basta entrar em contato pelo botão abaixo. Retornamos com uma proposta personalizada de acordo com a necessidade da sua instituição.',
  ...
  en: {
    ...
    'faq.a2':'Yes. Our logistics structure allows us to serve clients in all regions of the country, with lead times and conditions tailored to each operation.',
    'faq.q3':'What product lines do you offer?',
    'faq.a3':'We work with hospital lines, monitoring, life support, accessories, and disposables. The full portfolio can be consulted with our commercial team.',
    'faq.q4':'How do I request a quote?',
    'faq.a4':'Simply get in touch via the button below. We will respond with a personalized proposal based on your institution\'s needs.',
